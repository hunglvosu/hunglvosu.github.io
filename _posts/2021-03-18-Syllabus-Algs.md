...
| --------------- | ----------------------------------------------- | ------------------------------------------------------------ |
| 02 Sept         | Intro, Master theorem, Mergesort                | [Erickson's note on recursion](http://jeffe.cs.illinois.edu/teaching/algorithms/book/01-recursion.pdf) |
| 07 Sept         | Closest Pair, Matrix Multiplication             | [DPV's chapter 2](https://people.eecs.berkeley.edu/~vazirani/algorithms/chap2.pdf) |
| 09 Sept         | Fast Fourier Transform                          | [Erickson's note on FFT](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/A-fft.pdf) |
| 14 Sept         | Intro Greedy, Job Scheduling                    | [Erickson's note on geedy algs](http://jeffe.cs.illinois.edu/teaching/algorithms/book/04-greedy.pdf) |
| 16 Sept         | Minimum Spanning Tree                           | [Erickson's note on MST](http://jeffe.cs.illinois.edu/teaching/algorithms/book/07-mst.pdf) |
| 21 Sept         | Matroid                                         | [Erickson's note on matroid](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/E-matroids.pdf) |
| 23 Sept         | Subset Sum, Optimal BST                         | [Erickson's note on DP](http://jeffe.cs.illinois.edu/teaching/algorithms/book/03-dynprog.pdf) |
| 28 Sept         | SSSP and APSP                                   | [Erickson's note on SSSP](http://jeffe.cs.illinois.edu/teaching/algorithms/book/08-sssp.pdf) and [APSP](http://jeffe.cs.illinois.edu/teaching/algorithms/book/09-apsp.pdf) |
| 30 Sept         | TSP and Independent Set on Trees                | [DPV's chapter 6](https://people.eecs.berkeley.edu/~vazirani/algorithms/chap6.pdf) and [Erickson's note on DP](http://jeffe.cs.illinois.edu/teaching/algorithms/book/03-dynprog.pdf) |
...
| 28 Oct          | Introduction to Linear Programming              | [Erickson's note on LP](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/H-lp.pdf) |
| 02 Nov          | LP Duality                                      | [Erickson's note on LP](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/H-lp.pdf) |
| 04 Nov          | Simplex Algorithm                               | [Erickson's note on Simplex Algorithm](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/I-simplex.pdf) |
| 09 Nov          | P vs NP                                         | [Erickson's note on NP-hardness](http://jeffe.cs.illinois.edu/teaching/algorithms/book/12-nphard.pdf) |
| 11 Nov          | Veterans Day                                    |                                                              |
| 16 Nov          | Midterm 2                                       | Covering Randomized Algorithms, Maxflow, and LP              |
| 18 Nov          | NP-complete Problems                            | [Erickson's note on NP-hardness](http://jeffe.cs.illinois.edu/teaching/algorithms/book/12-nphard.pdf) |
| 23 Nov          | Vertex Cover,Set Cover                          | [Erickson's note on approximation algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/J-approx.pdf) |
| 25 Nov          | Thanksgiving                                    |                                                              |
| 30 Nov          | TSP, $k$-Center                                 | [Erickson's note on approximation algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/J-approx.pdf) |
| 02 Dec          | Subset Sum                                      | [Erickson's note on approximation algorithms](http://jeffe.cs.illinois.edu/teaching/algorithms/notes/J-approx.pdf) |
| 07 Dec          | Review                                          |                                                              |
