...
date: 2023-03-16
permalink: /posts/2025/10/Syllabus-Algs/
---

<span style="color:red">Last Updated: December 08  2025</span>.
...
| --------------- | ----------------------------------------------- | ------------------------------------------------------------ |
| 02 Feb         | Intro, Master theorem, Mergesort                | [Erickson's note on recursion](http://jeffe.cs.illinois.edu/teaching/algorithms/book/01-recursion.pdf) |
| 04 Feb         | Closest Pair, Matrix Multiplication             | [DPV's chapter 2](https://people.eecs.berkeley.edu/~vazirani/algorithms/chap2.pdf) |
...
- Homework (35%): Homework is **bi-weekly** and includes 6 assignments. The lowest assignment will be dropped.
- Weekly Quizzes (4%): We will have 11 quizzes total, and the lowest quiz will be dropped. 
- Attendance (1%).
- Midterms 1 + 2: (35%), the maximum will be 20% and the minimum will be 15%
- Final (25%): Scheduled by the university and will be comprehensive.
